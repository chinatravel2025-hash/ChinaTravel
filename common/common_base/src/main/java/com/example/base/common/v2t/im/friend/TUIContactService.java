package com.example.base.common.v2t.im.friend;
...
public class TUIContactService implements TUIInitializer, ITUIContactService {
    ...
    public static TUIContactService getInstance() {
        if(instance == null){
           new TUIContactService().init(getAppContext());
        }
        return instance;
    }
    ...
    public void notiyFriendRemarkChange(String userId,String remark){
        Map<String,Object> map = new HashMap<>();
        map.put(TUIConstants.TUIContact.FRIEND_ID,userId);
        map.put(TUIConstants.TUIContact.FRIEND_REMARK,remark);
        TUICore.notifyEvent(TUIConstants.TUIContact.EVENT_FRIEND_INFO_CHANGED, TUIConstants.TUIContact.EVENT_SUB_KEY_FRIEND_REMARK_CHANGED,map);
    }
     ...
     */
    public void removeContactEventListener(ContactEventListener contactEventListener){
