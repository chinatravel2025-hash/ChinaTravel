...
class V2TCustomBean : TUIMessageBean() {

    class Builder {
        private val bean = V2TCustomBean()

        fun build(): V2TCustomBean {
    ...
    companion object {
         ...
         * 消息来源未知
         */
        const val MSG_SOURCE_UNKNOWN = 0

        /**
         * 后台主动 push 的消息
         */
        const val MSG_SOURCE_ONLINE_PUSH = 1

        /**
         * SDK 拉取的历史消息
         */
        const val MSG_SOURCE_GET_HISTORY = 2
