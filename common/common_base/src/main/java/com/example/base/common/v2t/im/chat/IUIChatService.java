...
import com.example.base.common.v2t.im.core.ITUIService;
import com.example.base.common.v2t.im.core.interfaces.ITUINotification;

import java.util.Map;

public interface IUIChatService extends ITUIService, ITUINotification {
    /**
     * 1、发送消息
     *   Send Message
     * 
