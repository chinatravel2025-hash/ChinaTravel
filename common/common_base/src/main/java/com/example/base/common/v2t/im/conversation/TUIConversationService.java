package com.example.base.common.v2t.im.conversation;
...
import com.example.base.common.v2t.im.conversation.interfaces.ITUIConversationService;
import com.example.base.common.v2t.im.conversation.interfaces.ConversationEventListener;
import com.example.base.common.v2t.im.conversation.interfaces.ConversationGroupNotifyListener;
...
public class TUIConversationService implements TUIInitializer,ITUIConversationService {
    ...
    public static synchronized TUIConversationService getInstance() {

        if(instance == null){
            instance = new TUIConversationService();
            instance.init(getAppContext());
        }
        return instance;
    }
...
//                presenter.updateUnreadTotalByDiff(conversationAllGroupUnreadDiff);
        ...
        if (conversationEventListener == null) {
            LogUtils.e(TAG, "execute " + method + " failed , conversationEvent listener is null");
            return result;
        }
    ...
    private void handleConversationGroupChangedEvent(String subKey, Map<String, Object> param) {
        if (TextUtils.equals(subKey, TUIConversationConstants.EVENT_CONVERSATION_GROUP_CHANGE_ADD)) {
            if (param == null || param.isEmpty()) {
                LogUtils.e(TAG, "EVENT_CONVERSATION_GROUP_CHANGE_ADD param is null");
                return;
            }
            ...
            if (eventListener != null) {
                ...
                LogUtils.e(TAG, "eventListener is null");
            }
        } else if (TextUtils.equals(subKey, TUIConversationConstants.EVENT_CONVERSATION_GROUP_ADD_DATA)) {
            if (param == null || param.isEmpty()) {
                LogUtils.e(TAG, "EVENT_CONVERSATION_GROUP_ADD_DATA param is null");
                return;
            }
            ...
            if (param == null || param.isEmpty()) {
                LogUtils.e(TAG, "EVENT_CONVERSATION_GROUP_ADD_MARK_DATA param is null");
                return;
            }
            ...
            if (param == null || param.isEmpty()) {
                LogUtils.e(TAG, "EVENT_CONVERSATION_GROUP_CHANGE_DELETE param is null");
                return;
            }
            ...
            if (param == null || param.isEmpty()) {
                LogUtils.e(TAG, "EVENT_CONVERSATION_GROUP_CHANGE_RENAME param is null");
                return;
            }
            ...
            if (param == null || param.isEmpty()) {
                LogUtils.e(TAG, "EVENT_CONVERSATION_GROUP_CHANGE_UNREAD_COUNT param is null");
                return;
            }
    ...
    private void initIMListener() {
        V2TIMManager.getConversationManager().addConversationListener(new V2TIMConversationListener() {
            ...
            public void onSyncServerStart() {
                syncFinished = false;
                LogUtils.i(TAG,"onSyncServerStart 执行了");
            }

            @Override
            public void onSyncServerFinish() {
                LogUtils.i(TAG,"onSyncServerFinish 执行了");
            ...
            public void onSyncServerFailed() {
                LogUtils.i(TAG,"onSyncServerFailed 执行了");
            ...
            public void onNewConversation(List<V2TIMConversation> conversationList) {
                ...
                LogUtils.i(TAG,"onNewConversation 执行了");
            ...
            public void onConversationChanged(List<V2TIMConversation> conversationList) {
                ...
                LogUtils.i(TAG,"onConversationChanged 执行了");
            ...
            public void onTotalUnreadMessageCountChanged(long totalUnreadCount) {
                LogUtils.i(TAG,"onTotalUnreadMessageCountChanged 执行了");
                ConversationEventListener conversationEventListener = getInstance().getConversationEventListener();
                if (conversationEventListener != null) {
            ...
            public void onConversationDeleted(List<String> conversationIDList) {
                ...
                LogUtils.i(TAG,"onConversationDeleted 执行了");
