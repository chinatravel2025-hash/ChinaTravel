...
public class PolicySpannableString extends SpannableString {
    String originalString;
    GenericCompact.Functor<String, Void> mOnClick;
    public PolicySpannableString(String originalString, GenericCompact.Functor<String, Void> onClick) {
        super(originalString);
        this.originalString = originalString;
        this.mOnClick = onClick;
    }

    public PolicySpannableString(String originalString) {
        super(originalString);
        this.originalString = originalString;
        this.mOnClick = null;
    }
