    ...
    public static final class TUIChat {
        ...
        public static class Method {
            ...
            public static class RegisterCustomMessage {
                public static final String CLASSIC_SERVICE_NAME      = Service.CLASSIC_SERVICE_NAME;
                public static final String MINIMALIST_SERVICE_NAME   = Service.MINIMALIST_SERVICE_NAME;
