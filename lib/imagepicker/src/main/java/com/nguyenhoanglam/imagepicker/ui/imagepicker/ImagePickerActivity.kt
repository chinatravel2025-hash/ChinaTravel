...
class ImagePickerActivity : AppCompatActivity(), OnFolderClickListener, OnImageSelectListener {
    ...
    private val titleClickListener = View.OnClickListener {
        viewModel.showSelectAlbum.value = !viewModel.showSelectAlbum.value!!
        binding.toolbar.showSelectAlbum(viewModel.showSelectAlbum.value!!)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.selectedImages.observe(this) {
            binding.toolbar.highlightDoneButton(it.isNotEmpty())
        }
        viewModel.selectedAlbumName.observe(this) {
    ...
    private fun handleBackPress() {
        if(viewModel.showSelectAlbum.value == true) {
            viewModel.showSelectAlbum.value = false
            binding.toolbar.showSelectAlbum(false)
            return
        }
    ...
    override fun onFolderClick(folder: Folder) {
        viewModel.selectedAlbumId.value = folder.bucketId
        viewModel.selectedAlbumName.value = folder.name
        viewModel.showSelectAlbum.value = false
        binding.toolbar.showSelectAlbum(false)
//        supportFragmentManager.beginTransaction()
//            .add(
