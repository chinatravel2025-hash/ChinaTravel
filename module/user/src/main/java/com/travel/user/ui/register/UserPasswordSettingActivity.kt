...
@Route(path = ARouterPathList.USER_PASSWORD_SET)
class UserPasswordSettingActivity : BaseStatusBarActivity() {

    private lateinit var binding: UserActivityPasswordSetBinding
    private lateinit var mVM: UserPasswordSettingVM
    ...
    private fun registerInputListener() {
        ...
        binding.apply {
            softInputListener = InputMonitorHelpUtils.softInputListener(this@UserPasswordSettingActivity, object :
